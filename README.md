...
Köszönet Tibinek aki létrehozta az eredeti showfile-t!

Showfile elrendezés:
Execute window:
    Egy ebibálos (soft palate, tempo...)
Fader layers:
    Egy az ebibálokhoz
    Második a default programokhoz
        Default (Front+utca+gégen)
        NT
        Üres hely saját questackhez